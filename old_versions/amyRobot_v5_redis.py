...
with model:
    ...
    #nengo.Connection(lateral_redis_basal, basal_in_redis, eval_points=input_data, function=output_data,
    #                 scale_eval_points=False, transform=per_input)
    ...
    #nengo.Connection(lateral_redis_central, central_in_redis, function=fast_reaction)   # added by Timmer for redis
